...
if now >=target:print("@MRBMOX دخن لا ضوج 💲 راسلني حتى افعلك Tokyo")
else:print("Tokyo")
import os 
...
def banner():
	...
	print("""\033[1;91m\033[1;41m\033[1;97m  Tool : @N_C_P\033[;0m\033[1;91m\033[1;92m
...
def login():
	#print(logo)
	banner()
	SHADj('\033[1;96m[1] File Cloning[من ملف]\n\x1b[1;92m ')
	SHADj('\033[0;97m===============================================')
